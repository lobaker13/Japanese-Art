...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { category: @keyword.category, name: @keyword.name } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { category: @keyword.category, name: @keyword.name } }
